package com.ks.orderservice.order.api;

import com.ks.orderservice.order.application.OrderApplicationService;
...
public class OrderController {
    ...
    public ResponseEntity<CreateOrderResponse> createOrder(@RequestBody CreateOrderRequest createOrderRequest) {
        ...
        return ResponseEntity.ok(orderApplicationService.create(createOrderRequest));
    }
}
